...
if [ -d "$CONF_DIR" ]; then
    ...
    git clone https://github.com/acdcbyl/Dotfiles-arch.git --depth 1 --branch main
fi
...
continue_prompt "Copying configuration files to $HOME..." "cd dotfiles-arch && cp -R .config/* ~/.config/"
